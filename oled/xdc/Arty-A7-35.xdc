...
set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { sdin        }]; #IO_L12N_T1_MRCC_35 Sch=jd[2]
...
set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { res         }]; #IO_L14N_T2_SRCC_35 Sch=jd[8]
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { vccen       }]; #IO_L15P_T2_DQS_35 Sch=jd[9]
set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { pmoden      }]; #IO_L15N_T2_DQS_35 Sch=jd[10]
